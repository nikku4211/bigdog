...
objlist = mmc3 init main bg player \
pads ppuclear
...
EMU := cmd.exe /C/Users/x/Documents/Nikku4211Archive/NEStopia/Mesen/X/1.0.0/mesen
DEBUGEMU := cmd.exe /C/Users/x/Documents/Nikku4211Archive/NEStopia/Mesen/X/1.0.0/mesen
...
map.txt $(title).nes: mmc3.cfg $(objlistntsc)
...
$(objdir)/main.o: $(objdir)/bggfx.chr $(objdir)/spritegfx.chr \
	$(objdir)/pixeldogwalksource1.chr \
	$(objdir)/pixeldogwalksource2.chr \
	$(objdir)/pixeldogwalksource3.chr \
	$(objdir)/pixeldogwalksource4.chr \
	$(objdir)/pixeldogwalksource5.chr \
	$(objdir)/pixeldogwalksource6.chr \
	$(objdir)/pixeldogwalksource7.chr \
	$(objdir)/pixeldogwalksource8.chr \
	$(objdir)/pixeldogwalksource9.chr \
	$(objdir)/pixeldogwalksource10.chr

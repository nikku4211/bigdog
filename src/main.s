...
.segment "CHR0"
        .align $800
        .incbin "obj/nes/pixeldogwalksource1.chr"

        .segment "CHR1"
        .align $800
        .incbin "obj/nes/pixeldogwalksource2.chr"
        
        .segment "CHR2"
        .align $800
        .incbin "obj/nes/pixeldogwalksource3.chr"
        
        .segment "CHR3"
        .align $800
        .incbin "obj/nes/pixeldogwalksource4.chr"
        
        .segment "CHR4"
        .align $800
        .incbin "obj/nes/pixeldogwalksource5.chr"
        
        .segment "CHR5"
        .align $800
        .incbin "obj/nes/pixeldogwalksource6.chr"
        
        .segment "CHR6"
        .align $800
        .incbin "obj/nes/pixeldogwalksource7.chr"
        
        .segment "CHR7"
        .align $800
        .incbin "obj/nes/pixeldogwalksource8.chr"
        
        .segment "CHR8"
        .align $800
        .incbin "obj/nes/pixeldogwalksource9.chr"
        
        .segment "CHR9"
        .align $800
        .incbin "obj/nes/pixeldogwalksource10.chr"
.segment "CHR10"
